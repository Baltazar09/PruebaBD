CREATE TABLE [dbo].[t_srv_reporte_averia] (
    ...
    CONSTRAINT [FK_T_SRV_REPORTE_AVERIA_T_CAT_CANTON] FOREIGN KEY ([FK_CANTON], [FK_PROVINCIA]) REFERENCES [dbo].[t_cat_canton] ([PK_CANTON], [PK_PROVINCIA]),
    CONSTRAINT [FK_T_SRV_REPORTE_AVERIA_T_CAT_DISTRITO] FOREIGN KEY ([FK_DISTRITO], [FK_CANTON], [FK_PROVINCIA]) REFERENCES [dbo].[t_cat_distrito] ([PK_DISTRITO], [PK_CANTON], [PK_PROVINCIA]),
    CONSTRAINT [FK_T_SRV_REPORTE_AVERIA_T_CAT_PROVINCIA] FOREIGN KEY ([FK_PROVINCIA]) REFERENCES [dbo].[t_cat_provincia] ([PK_PROVINCIA]),
