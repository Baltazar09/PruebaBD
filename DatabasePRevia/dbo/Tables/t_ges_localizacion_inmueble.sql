CREATE TABLE [dbo].[t_ges_localizacion_inmueble] (
    ...
    --CONSTRAINT [FK_t_ges_localizacion_inmueble_t_cat_canton] FOREIGN KEY ([FK_CANTON], [FK_PROVINCIA]) REFERENCES [catalogos].[t_cat_canton] ([PK_CANTON], PK_PROVINCIA),
    CONSTRAINT [FK_t_ges_localizacion_inmueble_t_cat_distrito] FOREIGN KEY ([FK_DISTRITO], [FK_CANTON], [FK_PROVINCIA]) REFERENCES [catalogos].[t_cat_distrito] ([PK_DISTRITO], [PK_CANTON], [PK_PROVINCIA]),
